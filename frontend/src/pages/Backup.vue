    ...
    <div v-else class="space-y-6">
      ...
      <section class="rounded-xl border border-line bg-surface p-4 space-y-3">
        ...
        <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
          ...
          <label class="text-xs text-faint">Key prefix (optional)<input v-model="s3.prefix" placeholder="vantage/" class="mt-1 block w-full rounded-lg border border-line bg-surface2 px-3 py-2 text-sm text-fg placeholder:text-faint focus:border-accent/60 focus:outline-none" /></label>
